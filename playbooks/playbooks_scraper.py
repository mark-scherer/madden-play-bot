...
def _playbooks_to_csv(filepath: str, playbooks: List[Playbook]) -> None:
...
def _download_play_images(output_dir: str, playbooks: List[Playbook]) -> None:
...
def scrape():
    ...
    _playbooks_to_csv(filepath=PLAYBOOK_CSV_PATH, playbooks=playbooks)
    _download_play_images(output_dir=PLAYBOOK_IMAGES_DIR, playbooks=playbooks)